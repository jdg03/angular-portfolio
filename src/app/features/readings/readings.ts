...
export class ReadingsComponent {
  ...
  protected readonly activeFilterClasses = 'px-4 py-2 rounded-lg bg-primary text-background font-mono text-[10px] font-bold shadow-[0_0_12px_rgba(210,187,255,0.3)] transition-all cursor-pointer';
  protected readonly inactiveFilterClasses = 'px-4 py-2 rounded-lg bg-surface-container border border-outline-variant/10 text-on-surface-variant font-mono text-[10px] hover:text-white hover:border-primary/30 transition-all cursor-pointer';
